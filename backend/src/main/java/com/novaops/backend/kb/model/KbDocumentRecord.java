...
public class KbDocumentRecord {
  private String id,title,fileName,fileType,storagePath,status,errorMsg,createdBy; private Long fileSize; private Integer chunkCount; private LocalDateTime createdAt,updatedAt;
