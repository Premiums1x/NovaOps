...
public class QdrantKbRetrievalService implements KbRetrievalService {
  ...
  public RetrievalResult retrieve(String tenantId,String query,int topK,double minScore){
    return new RetrievalResult(vectorStore.search(tenantId,query,topK,minScore));
  }
}
