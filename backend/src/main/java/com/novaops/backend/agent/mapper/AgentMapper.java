...
public interface AgentMapper {
  void insertConversation(ConversationRecord record); ConversationRecord findConversation(@Param("tenantId") String tenantId,@Param("userId") String userId,@Param("id") String id); List<ConversationRecord> listConversations(@Param("tenantId") String tenantId,@Param("userId") String userId); void touchConversation(@Param("id") String id); void insertMessage(AgentMessageRecord record); List<AgentMessageRecord> listMessages(@Param("conversationId") String conversationId);
}
